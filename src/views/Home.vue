        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800">1.582</div>
            </div>
            <div class="col-auto">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <div class="mt-4 text-center small">
            <span class="mr-2">
              <font-awesome-icon icon="circle" />Direct
            </span>
            <span class="mr-2">
              <font-awesome-icon icon="circle" /> Social
            </span>
            <span class="mr-2">
              <font-awesome-icon icon="circle" /> Referral
            </span>
          </div>
        </div>
      </div>
